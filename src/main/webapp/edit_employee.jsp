...
<div class="edit">
  <form:form name="edit" class="form-horizontal" method="post" action="update_employee.html" commandName="employee" >
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        ...
        <p style="color: brown; font-size: 14px"><c:out value="${requestScope.salaryError}"></c:out></p>--%>
    ...
    <div class="add">
      <input type="submit" class="btn btn-large btn-success" name="addSubmit" value="Edit" style="margin-top: 26px;">
      <input type="hidden" name="id" value="${requestScope.employee.getId()}">
    </div>
  </form:form>
  <div class="cancel">
    <form action="employees.html" method="post">
      <input type="submit" class="btn btn-large btn-info" name="addSubmit" value="Cancel" style="margin-top: 26px;">
    </form>
  </div>
</div>
</body>
